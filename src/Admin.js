...
const Admin = () => {
  ...
  const apiUrl = 'https://sheet.best/api/sheets/6d66a3c7-c1e4-4ef5-95c1-dd1652c80211';
  ...
  useEffect(() => {
   ...
   const handleDelete = async (id) =>{
    try {
        const res=await fetch(`https://sheet.best/api/sheets/a23e5f83-9553-4870-85da-8aafff7aead9/${id-1}`,{method:"DELETE"});
